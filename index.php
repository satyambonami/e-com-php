        ...
        <div class="col-lg-9 offset-lg-2 text-center">
          <div class="hero-text">
            <div class="hero-text-tablecell">
              <p class="subtitle"><?php echo  $_SESSION['general']['bannersubtext']; ?></p>
              <h1><?php echo  $_SESSION['general']['bannermaintext']; ?></h1>
              <div class="hero-btns">
      ...
      <div class="row clearfix">
        ...
        <div class="content-column col-lg-6">
          ...
          <div class="text">Quisquam minus maiores repudiandae nobis, minima saepe id, fugit ullam similique! Beatae,
            minima quisquam molestias facere ea. Perspiciatis unde omnis iste natus error sit voluptatem accusant</div>
          <!--Countdown Timer-->
...
<!-- Mirrored from technext.github.io/fruitkha/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 11:51:01 GMT -->
